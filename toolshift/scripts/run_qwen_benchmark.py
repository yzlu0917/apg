...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run a public Qwen prompt baseline on any ToolShift benchmark.")
    ...
    parser.add_argument("--output-dir", default="artifacts/qwen_benchmark")
    ...
    benchmark_stem = Path(args.benchmark).stem.replace("_benchmark", "")
    agent_name = args.name or f"qwen_prompt_{benchmark_stem}"
