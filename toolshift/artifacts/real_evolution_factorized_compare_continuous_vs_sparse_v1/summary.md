...
- Records: `artifacts/real_evolution_family_holdout_continuous_capability_v1/records.json`
- Benchmark: `data/real_evolution_benchmark.json`
- Regime: `family_holdout_cv`
- Methods: `semantic_sparse_capability_gate, semantic_continuous_capability_gate`
...
## semantic_continuous_capability_gate vs semantic_sparse_capability_gate
