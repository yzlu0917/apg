...
- Methods: `semantic_capability_gate, semantic_learned_capability_gate`
...
| semantic_learned_capability_gate | 0.993 | 0.980 | 1.000 | 0.980 | 0.986 | 0.007 | 1.000 |

## semantic_learned_capability_gate vs semantic_capability_gate

- improved_pair_count: `0`
- regressed_pair_count: `1`
- improved_distinct_views: `0`
- regressed_distinct_views: `1`
...
- by_transform: `{"positive_version_migration": 1}`
- by_family_tag: `{"sheets": 1}`
- from_bucket: `{"correct_execute": 1}`
...
- `notion`: `CAA=1.000` `CAA+=1.000` `NOS=1.000` `count=16`
- `people`: `CAA=1.000` `CAA+=1.000` `NOS=1.000` `count=16`
- `sheets`: `CAA=0.938` `CAA+=0.833` `NOS=1.000` `count=16`
- `slack`: `CAA=1.000` `CAA+=1.000` `NOS=1.000` `count=16`
- `stripe`: `CAA=1.000` `CAA+=1.000` `NOS=1.000` `count=16`
