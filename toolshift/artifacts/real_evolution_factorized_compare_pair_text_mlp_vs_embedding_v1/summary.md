...
- Records: `artifacts/real_evolution_family_holdout_pair_text_mlp_v1/records.json`
- Benchmark: `data/real_evolution_benchmark.json`
- Regime: `family_holdout_cv`
- Methods: `semantic_embedding_capability_gate, semantic_pair_text_mlp_capability_gate`
...
| semantic_pair_text_mlp_capability_gate | 0.868 | 0.920 | 0.682 | 0.920 | 0.986 | 0.134 | 1.000 |

## semantic_pair_text_mlp_capability_gate vs semantic_embedding_capability_gate
...
- by_transform: `{"clean": 8, "negative_legacy_identifier_removed": 2, "negative_parent_scope_change": 2, "negative_removed_capability": 1, "negative_search_replacement": 2, "positive_version_migration": 4}`
- by_family_tag: `{"bitbucket": 2, "confluence": 10, "jira": 2, "notion": 4, "stripe": 1}`
- from_bucket: `{"correct_execute": 12, "correct_non_execute": 7}`
...
- `confluence`: `CAA=0.375` `CAA+=0.333` `NOS=1.000` `count=16`
- `drive`: `CAA=1.000` `CAA+=1.000` `NOS=1.000` `count=16`
...
- `sheets`: `CAA=1.000` `CAA+=1.000` `NOS=1.000` `count=16`
- `slack`: `CAA=1.000` `CAA+=1.000` `NOS=1.000` `count=16`
- `stripe`: `CAA=0.938` `CAA+=1.000` `NOS=0.750` `count=16`
