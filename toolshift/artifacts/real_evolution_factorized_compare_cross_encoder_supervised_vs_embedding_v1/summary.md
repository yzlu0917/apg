...
- Records: `artifacts/real_evolution_family_holdout_cross_encoder_supervised_v1/records.json`
- Benchmark: `data/real_evolution_benchmark.json`
- Regime: `family_holdout_cv`
- Methods: `semantic_embedding_capability_gate, semantic_cross_encoder_supervised_capability_gate`
...
| semantic_cross_encoder_supervised_capability_gate | 0.806 | 0.720 | 0.455 | 0.720 | 0.944 | 0.176 | 1.000 |

## semantic_cross_encoder_supervised_capability_gate vs semantic_embedding_capability_gate

- improved_pair_count: `0`
- regressed_pair_count: `28`
- improved_distinct_views: `0`
- regressed_distinct_views: `14`
...
- by_transform: `{"clean": 2, "negative_legacy_identifier_removed": 2, "negative_parent_scope_change": 2, "negative_removed_capability": 2, "negative_search_replacement": 2, "negative_source_removed": 2, "negative_space_key_lookup_split": 2, "positive_version_migration": 14}`
- by_family_tag: `{"bitbucket": 2, "confluence": 2, "drive": 4, "jira": 2, "notion": 4, "people": 4, "sheets": 6, "stripe": 4}`
- from_bucket: `{"correct_execute": 16, "correct_non_execute": 12}`
