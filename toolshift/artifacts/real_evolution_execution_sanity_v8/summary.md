...
| --- | ---: | ---: | ---: | ---: |
| `clean` | 36 | 1.000 | 1.000 | 1.000 |
| `negative_account_object_removed` | 1 | 1.000 | 0.000 | 0.000 |
...
| `negative_space_key_lookup_split` | 1 | 1.000 | 0.000 | 0.000 |
| `positive_version_migration` | 25 | 1.000 | 1.000 | 1.000 |
