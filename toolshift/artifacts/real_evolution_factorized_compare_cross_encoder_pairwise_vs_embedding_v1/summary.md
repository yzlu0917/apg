...
- Records: `artifacts/real_evolution_family_holdout_cross_encoder_pairwise_v1/records.json`
- Benchmark: `data/real_evolution_benchmark.json`
- Regime: `family_holdout_cv`
- Methods: `semantic_embedding_capability_gate, semantic_cross_encoder_pairwise_capability_gate`
...
| semantic_cross_encoder_pairwise_capability_gate | 0.812 | 0.720 | 0.500 | 0.720 | 0.944 | 0.169 | 1.000 |

## semantic_cross_encoder_pairwise_capability_gate vs semantic_embedding_capability_gate
