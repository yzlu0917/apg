...
def fit_hardneg_contrastive_scorer(
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate CTS with hard-negative contrastive scorers.")
    ...
    parser.add_argument("--baseline-prefix", default="hardneg")
    ...
    for theorem_id, test_indices in group_to_indices.items():
        ...
        for field, baseline_name in [("h_plus", "post_contrastive"), ("delta_h", "transition_contrastive")]:
            ...
            torch.manual_seed(0)
            src, var = fit_hardneg_contrastive_scorer(
